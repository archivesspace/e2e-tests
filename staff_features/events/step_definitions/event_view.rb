...
Given 'two Events have been created with a common keyword in their record link titles' do
  ...
  fill_in 'Outcome', with: "A #{@shared_accession_uuid}"
  ...
  visit "#{STAFF_URL}/events/new"
  fill_in 'Outcome', with: "B #{@shared_accession_uuid}"
  within '#event_date' do
    select 'Single', from: 'Type'
    fill_in 'Begin', with: '2020-01-01'
  end
