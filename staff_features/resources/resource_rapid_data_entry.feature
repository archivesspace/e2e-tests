Feature: Resource Rapid Data Entry
  ...
  # The following feature has a bug. Column removal, is reduced by 2 instead of 1.
  #
  # Scenario: Remove a column from the Rapid Data Entry table
  #    When the user clicks on 'Rapid Data Entry'
  #     And the user clicks on 'Columns: 45 visible'
  #     And the user unchecks the 'Basic Information - Title' checkbox
  #    Then the 'Basic Information - Title' column is no longer visible
  #
